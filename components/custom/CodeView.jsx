  ...
  return (
    <div className='relative'>
      <div className="bg-[#181818] w-full p-2 border">
        <div className="flex items-center flex-wrap  justify-center shrink-0 bg-black p-1 w-[140px] gap-3 rounded-full">
          <h2
      ...
      absolute top-0 rounded-lg w-full h-full flex items-center justify-center'>
        ...
        <h2 className='text-white'>DannyAI😎  is generating your files ...</h2>
      </div>}
    </div>
  );
}
